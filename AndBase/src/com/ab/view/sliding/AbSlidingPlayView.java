...
public class AbSlidingPlayView extends LinearLayout {
    ...
    // 小圆点的图片自定义路径
    private String displaySrc = "image/play_display1.png";

    private String hideSrc = "image/play_hide.png";
    ...
    public void setHideSrc(String hideSrc) {
        this.hideSrc = hideSrc;
    }
    ...
    public void initView(Context context) {
        ...
        navLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
        ...
        mNavLayoutParent.addView(navLinearLayout, new LinearLayout.LayoutParams(
        ...
        addView(mRelativeLayout, new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
                LayoutParams.WRAP_CONTENT));

        displayImage = AbFileUtil.getBitmapFromSrc(displaySrc);
        hideImage = AbFileUtil.getBitmapFromSrc(hideSrc);
